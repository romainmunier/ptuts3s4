 ...
 */
class getCarouselLikeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarouselLikeRepository' shared autowired service.
     *
     * @return \App\Repository\CarouselLikeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarouselLikeRepository.php';

        return $container->privates['App\\Repository\\CarouselLikeRepository'] = new \App\Repository\CarouselLikeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
