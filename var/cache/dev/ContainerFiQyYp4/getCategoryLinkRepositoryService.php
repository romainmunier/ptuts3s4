 ...
 */
class getCategoryLinkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoryLinkRepository' shared autowired service.
     *
     * @return \App\Repository\CategoryLinkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryLinkRepository.php';

        return $container->privates['App\\Repository\\CategoryLinkRepository'] = new \App\Repository\CategoryLinkRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
