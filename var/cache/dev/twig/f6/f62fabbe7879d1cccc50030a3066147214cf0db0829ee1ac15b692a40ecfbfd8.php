...
class __TwigTemplate_1fe8e0ef4fab29a487f3f670d43702de9293128e6598129c7da16f089dcf48c6 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo "\" href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("medias_add_gallery");
        echo "\">Ajouter des images</a>
                                    <h6 class=\"collapse-header text-";
        // line 73
        ...
        if (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN") || $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_DEVELOPERS"))) {
            ...
            echo "\">Messages envoyés</a>
                                        <a class=\"collapse-item text-";
            // line 125
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["userSettings"]) || array_key_exists("userSettings", $context) ? $context["userSettings"] : (function () { throw new RuntimeError('Variable "userSettings" does not exist.', 125, $this->source); })()), "theme", [], "any", false, false, false, 125), "html", null, true);
            echo "\" href=\"";
            ...
            echo " ";
            if (twig_in_filter("/dashboard/users", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 132, $this->source); })()), "request", [], "any", false, false, false, 132), "pathInfo", [], "any", false, false, false, 132))) {
                echo "active";
            }
    ...
    {
        return array (  380 => 148,  368 => 141,  364 => 140,  358 => 139,  354 => 138,  348 => 137,  336 => 132,  324 => 125,  318 => 124,  312 => 123,  308 => 122,  302 => 121,  298 => 120,  292 => 119,  280 => 114,  270 => 106,  267 => 105,  255 => 98,  251 => 97,  245 => 96,  241 => 95,  235 => 94,  223 => 89,  213 => 81,  211 => 80,  200 => 74,  196 => 73,  190 => 72,  186 => 71,  180 => 70,  168 => 65,  156 => 58,  152 => 57,  148 => 56,  144 => 55,  138 => 54,  126 => 49,  103 => 35,  83 => 25,  70 => 14,  66 => 10,  52 => 8,  43 => 1,);
    }
