    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["new"]) {
            ...
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["new"], "type", [], "any", false, false, false, 52), "SEND"))) {
                ...
                // line 56
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("news_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["new"], "id", [], "any", false, false, false, 56)]), "html", null, true);
                echo "\">Modifier</a>
                                        ";
            }
            // line 58
