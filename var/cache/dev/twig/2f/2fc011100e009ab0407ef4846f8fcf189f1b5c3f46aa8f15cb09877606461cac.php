...
class __TwigTemplate_263d2127ac49f969760145d749457c41025d7a528cb8eef826608a267c6572f3 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"wrapper\">
    ...
    <div class=\"d-flex flex-column {% if not userSettings.medieval[0] %}bg-{{ userSettings.theme }}{% else %}bg-none{% endif %}\" id=\"content-wrapper\">
        ...
        {% endblock %}
        {# Fin de la gestion de la page #}", "dashboard/settings/index.html.twig", "D:\\romainmunier\\Documents\\GitHub\\ptuts3s4\\templates\\dashboard\\settings\\index.html.twig");
    }
}
