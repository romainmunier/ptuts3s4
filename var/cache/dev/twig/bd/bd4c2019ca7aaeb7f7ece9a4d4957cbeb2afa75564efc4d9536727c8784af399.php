...
class __TwigTemplate_82e519272c642987615b67ce5ee6a313f6c2d79d0b369d13f72dec6fbf425fb0 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"wrapper\">
    ...
    <div class=\"d-flex flex-column {% if not userSettings.medieval[0] %}bg-{{ userSettings.theme }}{% else %}bg-none{% endif %}\" id=\"content-wrapper\">
        ...
        {% endblock %}
{# Fin de la gestion de la page #}", "dashboard/mailinglist/index.html.twig", "C:\\Users\\romainmunier\\Documents\\GitHub\\ptuts3s4\\templates\\dashboard\\mailinglist\\index.html.twig");
    }
}
