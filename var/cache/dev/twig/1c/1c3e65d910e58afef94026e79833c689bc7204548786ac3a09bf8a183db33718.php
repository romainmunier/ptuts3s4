...
class __TwigTemplate_98aeac8ecc9c672e24cfd3569cde2d4df440cd491b7795bce099fb6cb56650b8 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"wrapper\">
    ...
    <div class=\"d-flex flex-column {% if not userSettings.medieval[0] %}bg-{{ userSettings.theme }}{% else %}bg-none{% endif %}\" id=\"content-wrapper\">
        ...
        {% endblock %}
{# Fin de la gestion de la page #}", "dashboard/mailinglist/add.html.twig", "/Users/romainmunier/Documents/Projets/Symfony/ptuts3s4/templates/dashboard/mailinglist/add.html.twig");
    }
}
