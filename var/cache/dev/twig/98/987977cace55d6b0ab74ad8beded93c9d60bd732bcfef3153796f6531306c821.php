...
class __TwigTemplate_dd28beaa4626a73806880eb40c49567317e82f02db68e64e5c7efd386e391ee5 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"wrapper\">
    ...
    <div class=\"d-flex flex-column {% if not userSettings.medieval[0] %}bg-{{ userSettings.theme }}{% else %}bg-none{% endif %}\" id=\"content-wrapper\">
        ...
        {% endblock %}
{# Fin de la gestion de la page #}", "dashboard/user/index.html.twig", "C:\\Users\\romainmunier\\Documents\\GitHub\\ptuts3s4\\templates\\dashboard\\user\\index.html.twig");
    }
}
