...
return [
    ...
    'admin_link_add' => [['page'], ['_controller' => 'App\\Controller\\LinkController::linkHandle'], [], [['text', '/link/add/'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'admin_link_edit' => [['page', 'id'], ['_controller' => 'App\\Controller\\LinkController::linkHandle'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/link/edit'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'admin_link_delete' => [['page', 'id'], ['_controller' => 'App\\Controller\\LinkController::linkDelete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/link/delete'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'admin_catlink_add' => [['page'], ['_controller' => 'App\\Controller\\LinkController::catLinkHandle'], [], [['text', '/catlink/add/'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'admin_catlink_edit' => [['page', 'id'], ['_controller' => 'App\\Controller\\LinkController::catLinkHandle'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/catlink/edit'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'admin_catlink_delete' => [['page', 'id'], ['_controller' => 'App\\Controller\\LinkController::deleteCat'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/catlink/delete'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
