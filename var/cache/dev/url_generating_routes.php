...
=======
    'medias_add' => [['page', 'id'], ['_controller' => 'App\\Controller\\MediaController::add'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medias/add'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'medias_upload' => [['page', 'id'], ['_controller' => 'App\\Controller\\MediaController::add'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medias/upload'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
    'medias_delete' => [['page', 'id'], ['_controller' => 'App\\Controller\\MediaController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medias/delete'], ['variable', '/', '[^/]++', 'page', true], ['text', '/admin']], [], []],
